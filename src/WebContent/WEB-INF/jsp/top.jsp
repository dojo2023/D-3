	...
	<body>
		...
		<% if(userMode == 2) { %>
			 <a href="ReportServlet">
                <img class="report-icon" src="./images/reportIcon.png" alt="">
              </a>
		<% } %>
		<a href="SettingServlet">
                <img class="setting-icon" src="./images/settingIcon.png" alt="">
              </a>
		<a href="LogoutServlet">
                <img class="logout-icon" src="./images/logoutIcon.png" alt="">
              </a>
              </div>
...
<div class="main-category">
		...
		<a href="javascript:Id1.submit()">
                  <div class="category-item">
                    <img src="./images/categoryDoor.png" alt="">
                    <span>質問</span>
                  </div>
